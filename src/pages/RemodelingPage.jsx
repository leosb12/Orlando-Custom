...
import {
  ...
  Star, Hammer, Ruler, Wrench, Lightbulb, Eye,
} from 'lucide-react'
...
const steps = [
  {
    ...
    desc: 'We sit down with you, listen to your ideas, review the space, and help you define a clear vision — budget, materials, timeline, and design direction.',
  },
  {
    number: '02',
    icon: Ruler,
    title: 'Detailed Planning',
    desc: 'Before any demo, we plan every detail: materials, dimensions, structural requirements, and sequencing. A well-planned remodel runs on time and on budget.',
  },
  {
    number: '03',
    icon: Hammer,
    title: 'Demolition & Prep',
    desc: 'We remove the old cleanly and efficiently, protecting the rest of your home throughout the process. No mess left behind, no damage to surrounding areas.',
  },
  {
    number: '04',
    icon: Wrench,
    title: 'Expert Construction',
    desc: 'Our crew builds with precision — cabinets, tile, paint, flooring, trim. Every trade is handled by specialists who take pride in their craft.',
  },
  {
    number: '05',
    icon: Eye,
    title: 'Final Walkthrough',
    desc: 'We inspect every detail together. Every finish, every fit, every surface. We don\'t close the job until you\'re completely satisfied.',
  },
]
...
const guarantees = [
  {
    ...
    desc: 'One contractor, every trade. We handle tile, paint, flooring, and carpentry so you don\'t have to coordinate a dozen different subs.',
  },
  {
    icon: Award,
    title: 'Premium Craftsmanship',
    desc: 'We don\'t build to minimum standards. Every cabinet, tile, and finish is installed with the care and precision of a true craftsman.',
  },
  {
    icon: Users,
    title: 'No Subcontractors',
    desc: 'The experienced crew that quotes your remodel is the same team that shows up on day one and stays until the job is done.',
  },
  {
    icon: Clock,
    title: 'On-Time, On-Budget',
    desc: 'We set realistic timelines and stick to them. Transparent pricing from the start means no surprise invoices at the end.',
  },
]
    ...
    <div className="bg-black min-h-screen" ref={pageRef}>
      ...
      <section className="relative pt-36 pb-24 overflow-hidden bg-black">
        <div className="absolute inset-0 z-0">
          <img src="/cocina (1).jpg" alt="" aria-hidden="true" className="w-full h-full object-cover object-center" />
        </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center" style={{ opacity: visible ? 1 : 0, transform: visible ? 'translateY(0)' : 'translateY(24px)', transition: 'opacity 0.7s ease, transform 0.7s ease' }}>
          <div className="inline-flex items-center gap-2 bg-red-600/15 border border-red-600/30 rounded-full px-5 py-2 mb-6">
            <Hammer size={12} className="text-red-400" />
            <span className="text-red-400 text-xs font-bold uppercase tracking-[3px]">Custom Remodeling</span>
          </div>
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-white leading-none mb-6">
            SPACES{' '}
            <span className="text-red-500" style={{ textShadow: '0 0 40px rgba(220,38,38,0.6)' }}>REIMAGINED</span>
          </h1>
          <p className="text-gray-400 text-lg leading-relaxed max-w-2xl mx-auto mb-10">
            We transform kitchens, bathrooms, and living spaces from the ground up — with one
            experienced crew handling every trade, from demo to the final trim. Serving Bowling Green, KY.
          </p>
      ...
      <section className="py-20 bg-zinc-950">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { icon: Hammer, title: 'Kitchen Remodels', desc: 'New cabinets, countertops, backsplash, and paint — we rebuild kitchens that are functional, beautiful, and built to last.' },
              { icon: Wrench, title: 'Bathroom Renovations', desc: 'From simple refreshes to full gut-and-rebuild — we handle tile, fixtures, paint, and every detail in between.' },
              { icon: Lightbulb, title: 'Room Makeovers', desc: 'Any room in your home can be transformed. We bring your vision to life with craftsmanship and attention to every detail.' },
            ].map((item, i) => {
      ...
      <section className="py-24 bg-zinc-950">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">HOW WE{' '}<span className="text-red-500 drop-shadow-[0_0_20px_rgba(220,38,38,0.5)]">BUILD</span></h2>
            <p className="text-gray-400 max-w-xl mx-auto leading-relaxed">Every remodel follows a disciplined process — from first conversation to final walkthrough.</p>
          </div>
      ...
      <section className="py-24 bg-black">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-400 max-w-xl mx-auto leading-relaxed">When you hire Orlando&apos;s for a remodel, you get a full-service team that owns the result from start to finish.</p>
          </div>
          ...
          <div className="mt-10 bg-red-600/10 border border-red-600/25 rounded-2xl p-7 text-center">
            ...
            <p className="text-gray-400 max-w-xl mx-auto leading-relaxed">We don&apos;t consider the job finished until you walk through and give us the thumbs up. Every project — big or small — gets that same commitment.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-zinc-950 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6 text-center">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">READY TO{' '}<span className="text-red-500">REMODEL?</span></h2>
          <p className="text-gray-400 mb-8 leading-relaxed">Let&apos;s talk about your project. We offer free consultations and detailed quotes — no pressure, no obligation.</p>
